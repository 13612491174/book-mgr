...
var Card = defineComponent({
  ...
  methods: {
    getAction: function getAction(actions) {
      var actionList = actions.map(function (action, index) {
        ...
        }, [_createVNode("span", null, _isSlot(action) ? action : {
  ...
  render: function render() {
    ...
    var loadingBlock = _createVNode("div", {
      ...
      "gutter": 8
    }, _isSlot(_slot2 = _createVNode(Col, {
      "span": 22
      ...
      default: function _default() {
        return [_createVNode(Col, {
          "span": 6
        }, _isSlot(_slot5 = _createVNode("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot5 : {
          default: function _default() {
            return [_slot5];
          ...
          "span": 18
        }, _isSlot(_slot6 = _createVNode("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot6 : {
          default: function _default() {
            return [_slot6];
      ...
      default: function _default() {
        return [_createVNode(Col, {
          "span": 13
        }, _isSlot(_slot7 = _createVNode("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot7 : {
          default: function _default() {
            return [_slot7];
          ...
          "span": 9
        }, _isSlot(_slot8 = _createVNode("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot8 : {
          default: function _default() {
            return [_slot8];
      ...
      default: function _default() {
        return [_createVNode(Col, {
          "span": 4
        }, _isSlot(_slot9 = _createVNode("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot9 : {
          default: function _default() {
            return [_slot9];
          ...
          "span": 3
        }, _isSlot(_slot10 = _createVNode("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot10 : {
          default: function _default() {
            return [_slot10];
          ...
          "span": 16
        }, _isSlot(_slot11 = _createVNode("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot11 : {
          default: function _default() {
            return [_slot11];
    ...
    var head;
    var tabs = tabList && tabList.length ? _createVNode(Tabs, tabsProps, _isSlot(_slot12 = tabList.map(function (item) {
      var temp = item.tab,
          slots = item.slots;
