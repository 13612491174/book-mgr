...
export default {
  ...
  methods: {
    ...
    getPopupElement: function getPopupElement() {
      ...
      if (destroyPopupOnHide) {
        ...
        return _createVNode(Transition, transitionProps, {
          default: function _default() {
            ...
            }, _isSlot(_slot = _createVNode(PopupInner, popupInnerProps, {
              default: function _default() {
      ...
      return _createVNode(Transition, transitionProps, _isSlot(_slot3 = _withDirectives(_createVNode(Align, {
      ...
      }, _isSlot(_slot2 = _createVNode(PopupInner, popupInnerProps, {
        default: function _default() {
