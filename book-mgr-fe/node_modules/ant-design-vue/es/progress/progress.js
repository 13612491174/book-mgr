...
export default defineComponent({
  ...
  render: function render() {
    ...
    if (type === 'line') {
      ...
      progress = _createVNode(Line, lineProps, _isSlot(progressInfo) ? progressInfo : {
        default: function _default() {
          return [progressInfo];
        }
      });
      ...
      progress = _createVNode(Circle, circleProps, _isSlot(progressInfo) ? progressInfo : {
        default: function _default() {
          return [progressInfo];
        }
      });
    ...
    return _createVNode("div", progressProps, _isSlot(progress) ? progress : {
      default: function _default() {
        return [progress];
      }
    });
