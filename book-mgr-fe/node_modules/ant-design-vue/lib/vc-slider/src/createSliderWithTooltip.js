  ...
  return {
    ...
    methods: {
      ...
      handleWithTooltip: function handleWithTooltip(_a) {
        ...
        return (0, _vue.createVNode)(_vcTooltip.default, tooltipProps, _isSlot(_slot = (0, _vue.createVNode)(_Handle.default, handleProps, null)) ? _slot : {
    ...
    render: function render() {
      var componentProps = _extends(_extends({}, (0, _propsUtil.getOptionProps)(this)), {
