...
var Card = (0, _vue.defineComponent)({
  ...
  methods: {
    getAction: function getAction(actions) {
      var actionList = actions.map(function (action, index) {
        ...
        }, [(0, _vue.createVNode)("span", null, _isSlot(action) ? action : {
  ...
  render: function render() {
    var _slot, _slot2, _slot3, _slot4, _slot5, _slot6, _slot7, _slot8, _slot9, _slot10, _slot11, _slot12;
    ...
    var loadingBlock = (0, _vue.createVNode)("div", {
      ...
      "gutter": 8
    }, _isSlot(_slot2 = (0, _vue.createVNode)(_col.default, {
      "span": 22
      ...
      default: function _default() {
        return [(0, _vue.createVNode)(_col.default, {
          ...
          "span": 15
        }, _isSlot(_slot4 = (0, _vue.createVNode)("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot4 : {
          default: function _default() {
            return [_slot4];
      ...
      default: function _default() {
        return [(0, _vue.createVNode)(_col.default, {
          "span": 6
        }, _isSlot(_slot5 = (0, _vue.createVNode)("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot5 : {
          default: function _default() {
            return [_slot5];
          ...
          "span": 18
        }, _isSlot(_slot6 = (0, _vue.createVNode)("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot6 : {
          default: function _default() {
            return [_slot6];
      ...
      default: function _default() {
        return [(0, _vue.createVNode)(_col.default, {
          "span": 13
        }, _isSlot(_slot7 = (0, _vue.createVNode)("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot7 : {
          default: function _default() {
            return [_slot7];
          ...
          "span": 9
        }, _isSlot(_slot8 = (0, _vue.createVNode)("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot8 : {
          default: function _default() {
            return [_slot8];
      ...
      default: function _default() {
        return [(0, _vue.createVNode)(_col.default, {
          "span": 4
        }, _isSlot(_slot9 = (0, _vue.createVNode)("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot9 : {
          default: function _default() {
            return [_slot9];
          ...
          "span": 3
        }, _isSlot(_slot10 = (0, _vue.createVNode)("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot10 : {
          default: function _default() {
            return [_slot10];
          ...
          "span": 16
        }, _isSlot(_slot11 = (0, _vue.createVNode)("div", {
          "class": "".concat(prefixCls, "-loading-block")
        }, null)) ? _slot11 : {
          default: function _default() {
            return [_slot11];
    ...
    var head;
    var tabs = tabList && tabList.length ? (0, _vue.createVNode)(_tabs.default, tabsProps, _isSlot(_slot12 = tabList.map(function (item) {
      var temp = item.tab,
          slots = item.slots;
