  ...
  return (0, _vue.createVNode)(_SaveRef.default, {
    "children": function children(saveRef, getRef) {
      ...
      return (0, _vue.createVNode)(_TabBarRootNode.default, _objectSpread({
        "saveRef": saveRef
      }, attrs), _isSlot(_slot2 = (0, _vue.createVNode)(_ScrollableTabBarNode.default, _objectSpread({
        "saveRef": saveRef,
        "getRef": getRef
      }, attrs), _isSlot(_slot = (0, _vue.createVNode)(_TabBarTabsNode.default, _objectSpread({
        "saveRef": saveRef
      }, attrs), null)) ? _slot : {
