...
var _default2 = {
  ...
  methods: {
    ...
    getPopupElement: function getPopupElement() {
      ...
      if (destroyPopupOnHide) {
        ...
        return (0, _vue.createVNode)(_transition.Transition, transitionProps, {
          default: function _default() {
            ...
            }, _isSlot(_slot = (0, _vue.createVNode)(_PopupInner.default, popupInnerProps, {
              default: function _default() {
      ...
      return (0, _vue.createVNode)(_transition.Transition, transitionProps, _isSlot(_slot3 = (0, _vue.withDirectives)((0, _vue.createVNode)(_vcAlign.default, {
      ...
      }, _isSlot(_slot2 = (0, _vue.createVNode)(_PopupInner.default, popupInnerProps, {
        default: function _default() {
      ...
      if (props.mask) {
        ...
        if (maskTransition) {
          ...
          maskElement = (0, _vue.createVNode)(_transition.Transition, {
            "appear": true,
            "name": maskTransition
          }, _isSlot(maskElement) ? maskElement : {
            default: function _default() {
              return [_maskElement];
            }
          });
