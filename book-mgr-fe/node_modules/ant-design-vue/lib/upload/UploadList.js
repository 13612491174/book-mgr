    ...
    var list = items.map(function (file) {
      ...
      if (file.status === 'uploading') {
        ...
        progress = (0, _vue.createVNode)("div", {
          ...
          "key": "progress"
        }, _isSlot(loadingProgress) ? loadingProgress : {
          default: function _default() {
      ...
      var downloadOrDelete = listType !== 'picture-card' && (0, _vue.createVNode)("span", {
        ...
        "title": locale.downloadFile
      }, _isSlot(downloadIcon) ? downloadIcon : {
        default: function _default() {
          return [downloadIcon];
        }
      }), removeIcon && (0, _vue.createVNode)("a", {
        "title": locale.removeFile
      }, _isSlot(removeIcon) ? removeIcon : {
        default: function _default() {
          return [removeIcon];
        }
      })]);
      ...
      }, _isSlot(iconAndPreview) ? iconAndPreview : {
        default: function _default() {
          return [iconAndPreview];
        }
      }), actions, (0, _vue.createVNode)(_transition.Transition, transitionProps, _isSlot(progress) ? progress : {
        default: function _default() {
          return [progress];
        }
      })]);
      ...
      }) : (0, _vue.createVNode)("span", null, _isSlot(dom) ? dom : {
        default: function _default() {
          return [dom];
        }
      })]);
