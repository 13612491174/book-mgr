...
function defaultItemRender(opt) {
  ...
  return isLastItem ? (0, _vue.createVNode)("span", null, _isSlot(name) ? name : {
    ...
    genForRoutes: function genForRoutes(_ref) {
      ...
      return routes.map(function (route) {
        ...
        if (route.children && route.children.length) {
          ...
          overlay = (0, _vue.createVNode)(_menu.default, null, _isSlot(_slot2 = route.children.map(function (child) {
            var _slot;
