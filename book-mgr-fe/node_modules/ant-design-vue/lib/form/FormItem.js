...
var _default2 = (0, _vue.defineComponent)({
  ...
  methods: {
    ...
    renderWrapper: function renderWrapper(prefixCls, children) {
      ...
      return (0, _vue.createVNode)(_Col.default, colProps, _isSlot(children) ? children : {
        default: function _default() {
          return [children];
        }
      });
    ...
    renderLabel: function renderLabel(prefixCls) {
      ...
      return label ? (0, _vue.createVNode)(_Col.default, colProps, _isSlot(_slot = (0, _vue.createVNode)("label", {
        "for": htmlFor || fieldId,
